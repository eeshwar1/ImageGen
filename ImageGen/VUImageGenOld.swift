...
//                                    let otherColor = currentColor.withAlphaComponent(0.9)
//                                    
//                                    let colors: [CGFloat] = [
//                                    
//                                        otherColor.redComponent, otherColor.greenComponent, otherColor.blueComponent, otherColor.alphaComponent,
//                                        currentColor.redComponent, currentColor.greenComponent, currentColor.blueComponent, currentColor.alphaComponent
//                                    
//                                                                        ]
